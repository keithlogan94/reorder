...
/**
 * Base class that represents a row from the 'crm_email' table.
 *
 *
 *
 * @package    propel.generator.models.models.Base
 */
abstract class CrmEmail implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\models\\models\\Map\\CrmEmailTableMap';
    ...
    /**
     * The value for the crm_email_id field.
     *
     * @var        int
     */
    protected $crm_email_id;
    ...
    /**
     * Initializes internal state of models\models\Base\CrmEmail object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CrmEmail</code> instance.  If
     * <code>obj</code> is an instance of <code>CrmEmail</code>, delegates to
     * <code>equals(CrmEmail)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CrmEmail The current object, for fluid interface
     */
    ...
    /**
     * Get the [crm_email_id] column value.
     *
     * @return int
     */
    public function getCrmEmailId()
    {
        return $this->crm_email_id;
    }
    ...
    /**
     * Set the value of [crm_email_id] column.
     *
     * @param int $v new value
     * @return $this|\models\models\CrmEmail The current object (for fluent API support)
     */
    public function setCrmEmailId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->crm_email_id !== $v) {
            $this->crm_email_id = $v;
            $this->modifiedColumns[CrmEmailTableMap::COL_CRM_EMAIL_ID] = true;
        }
    ...
    public function setCrmAccountId($v)
    {
        ...
        if ($this->crm_account_id !== $v) {
            ...
            $this->modifiedColumns[CrmEmailTableMap::COL_CRM_ACCOUNT_ID] = true;
        }
    ...
    public function setEmailAddress($v)
    {
        ...
        if ($this->email_address !== $v) {
            ...
            $this->modifiedColumns[CrmEmailTableMap::COL_EMAIL_ADDRESS] = true;
        }
    ...
    public function setVerified($v)
    {
        ...
        if ($this->verified !== $v) {
            $this->verified = $v;
            $this->modifiedColumns[CrmEmailTableMap::COL_VERIFIED] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($this->start_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->start_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CrmEmailTableMap::COL_START_DATE] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ($this->end_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->end_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CrmEmailTableMap::COL_END_DATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CrmEmailTableMap::translateFieldName('CrmEmailId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crm_email_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CrmEmailTableMap::translateFieldName('CrmAccountId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crm_account_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CrmEmailTableMap::translateFieldName('EmailAddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email_address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CrmEmailTableMap::translateFieldName('Verified', TableMap::TYPE_PHPNAME, $indexType)];
            $this->verified = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CrmEmailTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CrmEmailTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = CrmEmailTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\models\\models\\CrmEmail'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCrmEmailQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CrmEmail::setDeleted()
     * @see CrmEmail::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCrmEmailQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CrmEmailTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CrmEmailTableMap::COL_CRM_EMAIL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'crm_email_id';
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_CRM_ACCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'crm_account_id';
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_EMAIL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'email_address';
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_VERIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'verified';
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_START_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'start_date';
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_END_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'end_date';
        }

        $sql = sprintf(
            'INSERT INTO crm_email (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'crm_email_id':
                        $stmt->bindValue($identifier, $this->crm_email_id, PDO::PARAM_INT);
                        break;
                    case 'crm_account_id':
    ...
    {
        $pos = CrmEmailTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CrmEmail'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CrmEmail'][$this->hashCode()] = true;
        $keys = CrmEmailTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCrmEmailId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\models\models\CrmEmail
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\models\models\CrmEmail The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CrmEmailTableMap::COL_CRM_EMAIL_ID)) {
            $criteria->add(CrmEmailTableMap::COL_CRM_EMAIL_ID, $this->crm_email_id);
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_CRM_ACCOUNT_ID)) {
            $criteria->add(CrmEmailTableMap::COL_CRM_ACCOUNT_ID, $this->crm_account_id);
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_EMAIL_ADDRESS)) {
            $criteria->add(CrmEmailTableMap::COL_EMAIL_ADDRESS, $this->email_address);
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_VERIFIED)) {
            $criteria->add(CrmEmailTableMap::COL_VERIFIED, $this->verified);
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_START_DATE)) {
            $criteria->add(CrmEmailTableMap::COL_START_DATE, $this->start_date);
        }
        if ($this->isColumnModified(CrmEmailTableMap::COL_END_DATE)) {
            $criteria->add(CrmEmailTableMap::COL_END_DATE, $this->end_date);
        }
    ...
    {
        $criteria = ChildCrmEmailQuery::create();
        $criteria->add(CrmEmailTableMap::COL_CRM_EMAIL_ID, $this->crm_email_id);
    ...
    {
        $validPk = null !== $this->getCrmEmailId();
    ...
    /**
     * Generic method to set the primary key (crm_email_id column).
     *
    ...
    {
        return null === $this->getCrmEmailId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \models\models\CrmEmail (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCrmEmailId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \models\models\CrmEmail Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCrmAccount(ConnectionInterface $con = null)
    {
        if ($this->aCrmAccount === null && ($this->crm_account_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCrmAccount->addCrmEmails($this);
             */
        }
    ...
    {
        if (null !== $this->aCrmAccount) {
            $this->aCrmAccount->removeCrmEmail($this);
        }
        $this->crm_email_id = null;
    ...
    {
        return (string) $this->exportTo(CrmEmailTableMap::DEFAULT_STRING_FORMAT);
    }
