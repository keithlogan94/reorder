...
abstract class City implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\models\\models\\Map\\CityTableMap';
    ...
    /**
     * Initializes internal state of models\models\Base\City object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\models\models\City The current object (for fluent API support)
     */
    ...
    public function setCountrycode($v)
    {
        ...
        if ($this->countrycode !== $v) {
            $this->countrycode = $v;
            $this->modifiedColumns[CityTableMap::COL_COUNTRYCODE] = true;
        }
    ...
    public function setDistrict($v)
    {
        ...
        if ($this->district !== $v) {
            $this->district = $v;
            $this->modifiedColumns[CityTableMap::COL_DISTRICT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CityTableMap::translateFieldName('Countrycode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countrycode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CityTableMap::translateFieldName('District', TableMap::TYPE_PHPNAME, $indexType)];
            $this->district = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CityTableMap::translateFieldName('Population', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\models\\models\\City'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_COUNTRYCODE)) {
            $modifiedColumns[':p' . $index++]  = 'CountryCode';
        }
        if ($this->isColumnModified(CityTableMap::COL_DISTRICT)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\models\models\City
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\models\models\City The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_COUNTRYCODE)) {
            $criteria->add(CityTableMap::COL_COUNTRYCODE, $this->countrycode);
        }
        if ($this->isColumnModified(CityTableMap::COL_DISTRICT)) {
            $criteria->add(CityTableMap::COL_DISTRICT, $this->district);
        }
        if ($this->isColumnModified(CityTableMap::COL_POPULATION)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \models\models\City (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \models\models\City Clone of current object.
     * @throws PropelException
     */
